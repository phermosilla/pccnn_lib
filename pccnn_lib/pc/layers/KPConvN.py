...
class KPConvN(IConvLayer):
    ...
    def __init__(self, 
        ...
        self.register_buffer('sigma_', torch.tensor((min_distance*2.0)/(1.0+min_distance)))
    ...
    def __compute_convolution__(self,
        ...
        if self.wamup_state_ and self.use_const_variance_init_:
            ...
            variance = ComputeKPConvNWeightVar.apply(
...
class KPConvNFactory(IConvLayerFactory):
    ...
    def __init__(self, 
        ...
        # Super class init.
        super(KPConvNFactory, self).__init__(
            p_num_kernel_pts,
            p_const_var_w_init,
            p_const_var_value)
